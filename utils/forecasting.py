"""Main module for performing recursive forecasting and visualization."""
import numpy as np
...
def plot_recursive_forecast(actual_data, forecast_data, save_path="images/forecast.png"):
    ...
    plt.plot(x_axis_forecast, forecast_data, label=f"Recursive Forecast ({len(forecast_data)} pts)",
             linestyle='--', color='red')
